...
export const appointmentService = {
  getAll: (page = 0, size = 10) => api.get(`/appointments?page=${page}&size=${size}`),
  ...
  complete: (id, observations = null) => api.put(`/appointments/${id}/complete`, observations ? { observations } : {}),
...
export const doctorService = {
  ...
  getSchedules: (doctorId, page = 0, size = 10) => api.get(`/doctors/${doctorId}/schedules?page=${page}&size=${size}`),
